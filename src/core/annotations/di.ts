import { makeDecorator, makeParamDecorator } from "../../common";
 ...
 * parameter.
 */
export const Inject = makeParamDecorator((token: InjectionToken<any>) => ({ token }));

/**
 * Specifies that an {@link Injector} should retrieve a dependency only from itself.
 */
export const Self = makeParamDecorator();
